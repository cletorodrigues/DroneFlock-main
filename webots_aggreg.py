...
class CrazyflieDrone:
    ...
    def init_devices(self):
        ...
        with open(self.file_name, 'w', newline='') as csvfile:
            ...
            csvwriter.writerow(['DRONE', 'Timestamp', 'Average Distance to Centroid', 'POSITION'])  # Write header
    ...
    def write_in_file(self, timestamp, avg_dist_2_centroid, position):
        ...
        with open(self.file_name, 'a', newline='') as csvfile:
            csvwriter = csv.writer(csvfile)
            csvwriter.writerow([self.my_id, timestamp, avg_dist_2_centroid, position])
